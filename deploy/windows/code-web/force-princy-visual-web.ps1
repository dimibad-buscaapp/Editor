...
$markers = @('cursor-editor-2026.05.24-unlock', 'forceVisualUnlock', 'princyCreate.actions', 'offlineBanner', 'reconnectBackend')
$found = @()
...
Write-Host "  3. DevTools painel chat: document.body.dataset.princyUiRev = cursor-editor-2026.05.24-unlock" -ForegroundColor DarkGray
